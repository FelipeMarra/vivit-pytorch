...
from att_blocks import MultiHeadAtt
...
class DecoderBlock(nn.Module):
    def __init__(self, emb_dim, context_size, n_heads):
        super().__init__()
        ...
        self.multi_head_att = MultiHeadAtt(emb_dim, context_size, head_size, n_heads)
